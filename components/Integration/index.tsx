        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              ...
              subtitle: `Kết nối liền mạch với các công cụ bạn đang sử dụng.`,
              description: `Dễ dàng tích hợp với Slack, Discord, Trello, Skype, ClickUp và nhiều nền tảng khác.
Quản lý dữ liệu, giao tiếp và quy trình làm việc mọi lúc, mọi nơi — ngay trong một nền tảng duy nhất.`,
            }}
          />
