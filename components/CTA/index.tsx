        ...
        <div className="mx-auto max-w-c-1390 rounded-lg bg-linear-to-t from-[#F8F9FF] to-[#DEE7FF] px-7.5 py-12.5 dark:bg-blacksection dark:bg-linear-to-t dark:from-transparent dark:to-transparent dark:stroke-strokedark md:px-12.5 xl:px-17.5 xl:py-0">
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              ...
              Tham gia cùng ChatX và tăng tốc hiệu suất làm việc ngay hôm nay

              </h2>
              <p>
              Khám phá nền tảng tạo Trợ lý AI thông minh – không cần lập trình – giúp bạn tự động hóa quy trình, chăm sóc khách hàng 24/7 và tối ưu chi phí vận hành.
              Dễ sử dụng. Linh hoạt. Tăng trưởng nhanh chóng
              </p>
            </motion.div>
            <motion.div
              variants={{
